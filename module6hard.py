...
class  Figure:
    ...
    def  __is_valid_sides(self, *new_sides):
        ...
        if len(new_sides) != self.sides_count:
            ...
            for i in new_sides:
                if isinstance(i, int)==False: #and a <= len(self.__sides) == True:
                    flag = False
                    break
        return flag
...
t1 = Triangle((233, 150, 80), 12)
print(t1.get_color())
print(t1.get_sides())
print('треуг', t1.get_square())
circle1 = Circle((200, 200, 100), 10) # (Цвет, стороны)
cube1 = Cube((222, 35, 130), 6)
# cube1 = Cube((222, 35, 130), 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7)
